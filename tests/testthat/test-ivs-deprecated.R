...
test_that("`iv_pairwise_intersect()` works but throws a deprecation warning", {
  x <- iv(1, 3)
  y <- iv(2, 6)
...
test_that("`iv_pairwise_symmetric_difference()` works but throws a deprecation warning", {
  x <- iv(1, 3)
  y <- iv(1, 2)
